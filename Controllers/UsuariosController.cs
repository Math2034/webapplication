...
namespace WebApplication2.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Data_Nascimento,Rendimento")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Nome,Email,Data_Nascimento,Rendimento")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
